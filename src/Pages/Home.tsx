  ...
  return (
    <Grid item xs sx={{ px: 2, py: 2 }}>
      ...
      <Box sx={{ maxWidth: '1536px' }}>
        ...
        <Paragraph>
          In the <Link to='/sentence'>Sentence Editor</Link>, add your sentence
          in the text box at the top. The sentence will be automatically be
          split by word. Under each word will be all of the Parts of Speech from
          the Syntax Rules. By coloring these Parts of Speech, the solver will
