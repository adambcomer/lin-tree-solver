  ...
  return (
    <Grid item xs sx={{ px: 3, py: 2 }}>
      ...
      <Paragraph>
        ...
        <Link to='/rules'> syntax rules</Link>,
        and <Link to='/viewer'>parsed trees</Link>.
      </Paragraph>
      ...
      <Paragraph>
        In the <Link to='/sentence'>Sentence Editor</Link>, add your sentence in the text box at the top. The sentence will be automatically be split by word.
      ...
      <Subtitle2>3. Build/Solve/Compute All Syntax Trees For a Sentence</Subtitle2>
      <Paragraph>
        In the <Link to='/viewer'>Tree Viewer</Link>, you can view all of the parsed trees.
      </Paragraph>
      ...
      <Question>Why are a few the syntax rules slightly different from the textbook?</Question>
      <Answer>
      ...
      <Answer>
        Yes. In the <Link to='/viewer'>Tree Viewer</Link>, there is a Image button in the top right.
        Clicking this button will generate an image based on the viewer window and automatically download it.
      </Answer>

      <Question>How do I share my Sentence/Syntax Rules with a friend?</Question>
      <Answer>
      ...
      <ul>
        ...
        <li><Paragraph>Sharing of Sentences/Syntax Rules/Trees</Paragraph></li>
        <li><Paragraph>Embeddable iframes</Paragraph></li>
        <li><Paragraph>Tooling to catch common syntax rule errors</Paragraph></li>
        <li><Paragraph>Improve rendering for larger trees</Paragraph></li>
        <li><Paragraph>Label structural relationships between all of the nodes in a tree</Paragraph></li>
      </ul>

      <Subtitle>Resources:</Subtitle>
      <Paragraph>Email: <OutboundLink href='mailto:adambcomer@gmail.com'>adambcomer@gmail.com</OutboundLink></Paragraph>
      <Paragraph>Project Site: <OutboundLink href='https://adambcomer.com/lin-tree-solver/'>Project Site</OutboundLink></Paragraph>
      <Paragraph>Personal Site: <OutboundLink href='https://adambcomer.com/'>Personal Site</OutboundLink></Paragraph>
      <Paragraph>Repository: <OutboundLink href='https://github.com/adambcomer/lin-tree-solver'>Project Github Repository</OutboundLink></Paragraph>
    </Grid>
  )
}
