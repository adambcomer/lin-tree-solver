...
const Page = () => {
  ...
  return (
    <div className=''>
      ...
      <Button color='primary' size='lg' onPress={onGetStarted} className='mt-8'>
        New Syntax Tree
      </Button>
      ...
      <p className='mt-2'>
        ...
        automatically be split by word. Under each word will be all of the Parts
        of Speech from the Syntax Rules. By coloring these Parts of Speech, the
        solver will find trees that satisfy these constraints.
      </p>
      <p className='mt-2'>
      ...
      <p className='mt-2'>
        ...
        generate an image based on the viewer window and automatically download
        it.
      </p>
      ...
      <h3 className='text-xl font-medium mt-4'>Is this project open source?</h3>
      <p className='mt-2'>
