      ...
      <div className='mb-16'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
          ...
          <Card>
            ...
            <CardBody>
              <p className='text-default-600'>
                X-Bar theory with specifiers, heads, and complements. Provides a
                more detailed hierarchical structure for phrasal categories and
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
          ...
          <div className='text-center'>
            ...
            <p className='text-default-600'>
              ...
              can select multiple tags when uncertain—the solver finds all valid
              interpretations.
            </p>
          </div>
        ...
        <Card>
          <CardBody>
            ...
            <p className='text-default-600 mt-4 text-sm'>
              ...
              means a VP has optional leading adverbs, a required verb, optional
              NP, and optional trailing PPs.
            </p>
          </CardBody>
        </Card>
      </div>
      ...
      <div className='mb-16'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
          <Card>
            ...
            <CardBody>
              <p className='text-default-600'>
                Works with any textbook or framework. Customize parts-of-speech
                and syntax rules to match your specific needs and linguistic
                theory.
              </p>
            </CardBody>
          </Card>
          ...
          <Card>
            ...
            <CardBody>
              <p className='text-default-600'>
                Automatically finds all possible interpretations when words have
                ambiguous parts-of-speech, helping you explore different
                syntactic analyses.
              </p>
            </CardBody>
          </Card>
      ...
      <div className='mb-16'>
        ...
        <div className='space-y-4'>
          <Card>
            ...
            <CardBody>
              ...
              <p className='text-default-600 mt-2'>
                <strong>Note:</strong> Workspaces are stored on a central server
                and can be edited by anyone with the URL. Don&apos;t share the
                link if you want to keep your work private.
              </p>
            </CardBody>
          </Card>
          ...
          <Card>
            ...
            <CardBody>
              <p className='text-default-600'>
                Yes! In the Tree Viewer, click the Image button in the top right
                corner to generate and download a high-quality image of your
                tree.
              </p>
            </CardBody>
          </Card>
          ...
          <Card>
            ...
            <CardBody>
              <p className='text-default-600'>
                ...
                could generate an endless chain of N&apos;s. We&apos;ve modified
                such rules to achieve the intended result without infinite
                recursion.
              </p>
              <p className='text-default-600 mt-2'>
          ...
          <Card>
            ...
            <CardBody>
              <p className='text-default-600'>
                This tool can solve many introductory syntax problems. However,
                if you&apos;re concerned about academic integrity, we recommend
                using it as a learning aid to check your work rather than
      ...
      <div className='py-12 border-t border-default-200'>
        <div className='text-center'>
          ...
          <p className='text-sm text-default-500 mt-8'>
            Based on <i>Syntax: A Generative Introduction, Third Edition</i> by
            Andrew Carnie
          </p>
        </div>
      </div>
