    ...
    <div className='max-w-7xl mx-auto'>
      ...
      <div className='text-center py-12'>
        ...
        <p className='text-xl text-default-600 max-w-3xl mx-auto'>
          Share your syntax trees with classmates, students, or colleagues in
          just a few clicks.
        </p>
      </div>
          ...
          <CardBody>
            <div className='space-y-4'>
              ...
              <p className='text-default-600'>
                ...
                ) that identifies your work. Anyone with this URL can access
                your syntax rules, sentence annotations, and generated trees.
              </p>
            </div>
          </CardBody>
        </Card>
          ...
          <CardBody>
            <div className='space-y-3'>
              ...
              <p className='text-default-600'>
                ...
                unwanted modifications to your work, only share the workspace
                URL with people you trust.
              </p>
            </div>
          </CardBody>
        </Card>
