    ...
    <div className='max-w-7xl mx-auto'>
      ...
      <div className='text-center py-12'>
        ...
        <p className='text-xl text-default-600 max-w-3xl mx-auto'>
          Learn how to build syntax trees for individual clauses like noun
          phrases or verb phrases instead of complete sentences.
        </p>
      </div>
        ...
        <Card>
          <CardBody>
            ...
            <p className='text-default-600'>
              ...
              starting at a SP or CP, you want to build a tree starting at a NP
              or VP. To do this, we have to adjust the &quot;root&quot; rule to
              shift the root to our desired clause type.
            </p>
          </CardBody>
        </Card>
      </div>
      ...
      <div className='space-y-8 mb-16'>
        ...
        <Card>
          ...
          <CardBody>
            <p className='text-default-600 mb-4'>
              Next, edit the root tags for these Syntax Rules. The root tags
              tell the tree builder where to start from to build your tree. The
        ...
        <Card>
          ...
          <CardBody>
            <p className='text-default-600 mb-4'>
              Next, add a new root tag to the empty set of root tags. The root
              tag you wish to set must already exist in the list of rules below.
              If the root you wish to use hasn&apos;t been added, add the new
              rule before modifying the root. In this example, I&apos;m going to
              change the root to a NP so I can build trees that start from a
              noun phrase.
            </p>
            <picture>
        ...
        <Card>
          ...
          <CardBody>
            <p className='text-default-600 mb-4'>
              Finally, click save in the top-right-hand corner. You should now
              be able to go to the Sentence Editor and the Tree Viewer to build
              and view your new trees. For my example, I can now build and view
